...
* Une série de composants @bcOAI...@ est prévue pour lire des données par moissonnage d'une source à partir du protocole OAI-PMH. Le développement de ces composants peut être suivi dans la branche "bcOAI":http://github.com/bcourtine/Composants-Talend-Open-Studio/tree/bcOAI
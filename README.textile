...
* Un composant @bcFileOutputSQL@ a pour but de créer un fichier script d'ordres SQL à partir des données entrantes. Le développement de ce composant peut être suivi dans la branche "bcFileOutputSQL":http://github.com/bcourtine/Composants-Talend-Open-Studio/tree/bcFileOutputSQL